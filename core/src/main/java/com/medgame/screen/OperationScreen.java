...
public class OperationScreen extends BaseScreen {
    ...
    protected void buildUI() {
        ...
        String title = clinicalCase != null ? clinicalCase.displayName : "Operation";
        root.add(new Label("OPERATION: " + title, labelStyle)).padBottom(20).row();
        root.add(new Label("Gameplay - Coming in Phase 2", labelStyle)).padBottom(40).row();
