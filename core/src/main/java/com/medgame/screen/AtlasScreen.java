...
public class AtlasScreen extends BaseScreen {
    ...
    protected void buildUI() {
        ...
        root.add(new Label("ANATOMICAL ATLAS", labelStyle)).padBottom(10).row();
        root.add(new Label("Gray's Anatomy + Netter's Reference", labelStyle)).padBottom(40).row();
        root.add(new Label("Interactive map - Coming in Phase 4", labelStyle)).padBottom(40).row();
